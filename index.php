...
mkdir('data/txt');
mkdir('data/api');
$API_KEY= '8352006841:AAExxVriQTxq0PvCfavwvdEih5lLco6b_VI';
...
$chall = "aaffyhg";
$useradmin = "@Df3dbot";
$sim =-1003620365727; #القناة الرسمية
$PAY =-1003527358173; #الارقام المكتملة
$ess =-1003628894065; #عمليات شراء الارقام
$eer =-1003547631203; #اشعارات الايميلات وتحويل الروبل
if($chat_id==6310927437){
$sudo=$chat_id;
}elseif($chat_id==6310927437){
$sudo=$chat_id;
}else{
$sudo==6310927437;
}
